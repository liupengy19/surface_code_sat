...
\begin{frame}{Comparison of XOR Encoding Strategies}
  \begin{enumerate}
    ...
    \item \textbf{Base-2 Encoding}: use $c = a \oplus b$ as the atomic building block \\
          \quad $\Rightarrow$ introduces more auxiliary variables but simpler constraints
    \item \textbf{Base-3 Encoding}: use $d = a \oplus b \oplus c$ as the atomic block \\
          \quad $\Rightarrow$ reduces auxiliary variables but increases clause complexity
  \end{enumerate}
  \begin{center}
