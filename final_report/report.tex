...
\Cref{fig:cadical} shows the results using CaDiCaL. CaDiCaL
is able to solve the UNSAT problem up to distance 13 but fails to
solve the UNSAT problem at distance 15. This is already the best
performance among all solvers.
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{../perf_filtered_plot.pdf}
  \caption{Check Time vs Distance for CaDiCaL}
  \label{fig:cadical}
\end{figure}
% \begin{table}[h]
%   \centering
...
\Cref{fig:cryptominisat} shows the results using
...
CryptoMiniSat is able to solve the UNSAT problem up to distance 9
but fails to solve the UNSAT problem at distance 11. We attribute this
to the fact that CryptoMiniSat is not optimized for cardinality constraints.
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{../cryptominisat_perf.pdf}
  \caption{Check Time vs Distance for CryptoMiniSat}
  \label{fig:cryptominisat}
\end{figure}
% \begin{table}[h]
%   \centering
...
\Cref{fig:z3} shows the results using Z3~\cite{de2008z3}.
We use the boolean theory, linear integer arithmetic and modular
arithmetic theories.
Z3
is the worst among
all solvers and can only solve the UNSAT problem up to distance 7.
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{../z3_perf.pdf}
  \caption{Check Time vs Distance for Z3}
  \label{fig:z3}
\end{figure}
% \begin{table}[h]
%   \centering
...
\Cref{fig:maxsat} shows the results using
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{../maxsat_perf.pdf}
  \caption{Check Time vs Distance for MaxSAT (RC2)}
  \label{fig:maxsat}
\end{figure}
% \begin{table}[h]
%   \centering
...
%   \end{tabular}
% \end{table}
% See Figure~\ref{fig:cryptominisat}.
% \begin{figure}[h]
%   \centering
%   \includegraphics[width=0.8\textwidth]{../cryptominisat_perf.pdf}
%   \caption{Check Time vs Distance for CryptoMiniSat}
...
A closely related structure arises in our setting. Consider variables $x_1,\ldots,x_{n}$ and the contradictory formula
\[
  \bigwedge_{i=1}^{n} x_i
  \;\land\;
  \sum_{i=1}^{n} x_i \le k.
...
constraints~\cite{WARNERS199863}, the resolution refutation of this encoding has exponential size, by
an immediate reduction from the lower bound of~\cite{haken1985intractability}.
